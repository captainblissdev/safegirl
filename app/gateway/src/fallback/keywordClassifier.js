 ...
 * research/experiments/baseline_classifier.py.
 *
...
/**
 * Function form of the keyword baseline, kept for callers that do not
 * need a classifier instance.
 */
const keywordBaseline = new KeywordBaselineClassifier();

function classify(text) {
  return keywordBaseline.classify(text);
}
